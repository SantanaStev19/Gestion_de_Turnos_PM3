...
import { cancelStatusAppointmentController, getAppointmentsByIdController, getAppointmentsController, registerAppointmentsController } from "../controllers/appointmentController";
