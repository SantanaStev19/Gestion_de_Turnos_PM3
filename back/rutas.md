...
- **Respuesta:**
  - 200: Si el usuario fue encontrado. check!
  - 404: Si el usuario no fue encontrado. check!
...
- **Respuesta:**
  - 201: Si el usuario fue creado. check!
  - 400: Si los datos son incorrectos. check!
...
- **Respuesta:**
  - 200: Si el usuario fue logueado. check!
  - 400: Si los datos son incorrectos. check!
...
- **Respuesta:**
  - 200: Si el turno fue encontrado. check!
  - 404: Si el turno no fue encontrado. check!
...
- **Respuesta:**
    - 201: Si el turno fue creado. check!
    - 400: Si los datos son incorrectos. check!
...
- **Respuesta:**
  - 200: Si los turnos fueron encontrados. check!
  - 404: Si no se encontraron turnos. check!
